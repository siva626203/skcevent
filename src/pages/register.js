     ...
     <Form className='md-3' onSubmit={formik.handleSubmit}>
      {verification?null:<><Container>
        <Form.Group className="mb-3" controlId="formBasicText">
          ...
          <a className='downlink' target="_blank" href='https://drive.google.com/file/d/1X2_2Yw2y8sND8qRO_kbmQPL-yEb9L72E/view?usp=sharing' rel="noreferrer">Get the Pass Code</a>
